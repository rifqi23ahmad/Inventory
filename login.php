              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h5 text-gray-900 mb-4">Sistem peminjaman Sarpras UPY</h1>
                    <h1 class="h4 text-gray-900 mb-4">Login Admin!</h1>
                  </div>
                  <form class="user" role="form" method="post" action="login_proses.php">
                    ...
                    <!-- <a href="login_proses.php" class="btn btn-primary btn-user btn-block">
                      Login
                    </a> -->

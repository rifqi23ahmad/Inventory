<?php
    ...
    s.id_kategori=k.id_kategori WHERE id_sarpras = $id");
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form role="form" action="sarpras_proses.php" method="post" enctype="multipart/form-data">
                <p></p>
                <input type="hidden" name="txt_id" value="<?php echo $row['id_sarpras']?>">

                <div class="form-group">
                    <label>Nama Sarpras</label>
                    <input class="form-control" placeholder=""  name="txt_nama" value="<?php echo $row['nama_sarpras']?>" required>
                </div>

                <div class="form-group">
                    <label>Kategori Barang</label>
                    <select required name="txt_id_kategori" class="form-control">
                        <option value="" selected=""><?php echo $row['kategori']?></option>
                        <?php
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="txt_ket" value="" required><?php echo $row['ket']?></textarea>
                </div>

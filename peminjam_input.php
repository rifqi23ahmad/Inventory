<?php
  ...
  // $query = mysqli_query($koneksi, "SELECT * FROM tb_pengguna  GROUP BY level");
?>
            ...
            <div class="card-body">
              ...
              <form role="form" action="peminjam_proses.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Masukkan Nama Peminjam "  name="txt_nama" value="" required> 
                </div>

                <div class="form-group">
                    <label>NIM/NIK/NIP</label>
                    <input class="form-control" placeholder=""  name="txt_nim" value="" required>
                </div>

                <div class="form-group">
                    <label>No Telp/WA</label>
                    <input class="form-control" placeholder=""  name="txt_telp" value="" required>
                </div>

            ...
            <div class="card-body">
              ...
              <form role="form" action="kategori_proses.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Masukkan Nama Kategori"  name="txt_kat" value="<?php echo $row['kategori']?>" required>
                    <input type="hidden" name="txt_id" value="<?php echo $row['id_kategori']?>">
                </div>

                <!-- <div class="form-group">
                    <label>Penyusutan</label>
                    <input class="form-control" placeholder=""  name="txt_susut" value="<?php echo $row['penyusutan']?>" required>
                </div> -->

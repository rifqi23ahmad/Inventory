            ...
            <div class="card-body">
              ...
              <form role="form" action="admin_proses.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Nama</label>
                    <input class="form-control" placeholder="Masukkan Nama"  name="txt_nama" value="" required>
                </div>

                <div class="form-group">
                    <label>Username</label>
                    <input class="form-control" placeholder=""  name="txt_user" value="" required>
                </div>

                <div class="form-group">
                    <label>Password</label>
                    <input class="form-control" placeholder=""  name="txt_pass" value="" required>
                </div>

                <!-- <div class="form-group">
                <label>Alamat</label>
                <textarea class="form-control" rows="3" name="txt_alamat" value="" required></textarea>
                </div> -->

                <!-- <div class="form-group">
                  <label>File Gambar</label>
                  <input class="form-control" type="file" name="file_gbr">
                </div> -->

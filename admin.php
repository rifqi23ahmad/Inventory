        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <p>
              <a href="admin_input.php" class="btn btn-info">Tambah Data</a>
              </p>
              </div>
              </div>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="btn btn btn-warning" href="admin_edit.php?id=<?php echo $row['id_admin']?>" 
                          onclick="return confirm('Apakah anda yakin ingin mengedit data ini?')">Edit</a>
                        <a class="btn btn btn-danger" href="admin_proses.php?url=<?php echo $row['id_admin']?>" 
